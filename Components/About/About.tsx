    ...
    <div className = {styles.Home__AboutMe} id = "About">
      <h1>About Me</h1>
        <article className = {styles.AboutMe__ArticleSection}>
            <section>
                <h2>A Brief Intro</h2>
                <p>Hello, my name is Bakhtiar Reza, a recent graduate from Penn State University. With classroom experience working on backend applications in Python and Java, and my previous internship experience working on a React Application, I have the flexibility to work in the Frontend, Backend, or Fullstack. I'm looking for a Software Engineering Internship working on either the front end or the back end. I have experience working with Typescript/JavaScript, React (Next.js), Node.js, and SQL.</p>
